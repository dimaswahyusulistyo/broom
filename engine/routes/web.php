...
Route::middleware($middleware)->group(function () {
    ...
    Route::get('/book', [HotelsController::class, 'book'])->name('book');
    Route::get('/checkout', [HotelsController::class, 'checkout'])->name('checkout');
    Route::get('/end', [HotelsController::class, 'end'])->name('end');
});
