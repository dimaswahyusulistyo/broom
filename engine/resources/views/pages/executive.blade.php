        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h6 class="section-title text-center text-primary text-uppercase">Executive Suite</h6>
                    <h1 class="mb-5">Kamar  <span class="text-primary text-uppercase">EXECUTIVE <h1 class="mb-5">Suite</span></h1>
                </div>
                <div class="row g-4">
                        ...
                        <div class="room-item shadow rounded overflow-hidden">
                            ...
                            <div class="p-4 mt-2">
                                <div class="d-flex justify-content-between mb-3">
                                    <h5 class="mb-0">Harbor View Hotel</h5>
                                    <div class="ps-2">
                                ...
                                <p class="text-body mb-3">Kompleks Zamrud Residence, Cluster Emerald, No. 45 </p>
                                <p class="text-body mb-3">Hotel tepi laut yang megah, Harbor View Hotel menawarkan pemandangan langsung ke pelabuhan dan laut biru yang luas. </p>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="room-item shadow rounded overflow-hidden">
                            ...
                            <div class="p-4 mt-2">
                                <div class="d-flex justify-content-between mb-3">
                                    <h5 class="mb-0">Royal Elegance Hotel</h5>
                                    <div class="ps-2">
                                        <small class="fa fa-star text-primary"></small>
                                        <small class="fa fa-star text-primary"></small>
                                        <small class="fa fa-star text-primary"></small>
                                ...
                                <p class="text-body mb-3">Jl. Cermin Indah, Kelurahan Damai Jaya, Kecamatan Serenity</p>
                                <p class="text-body mb-3">Kehangatan kerajaan dan keanggunan modern bertemu di Royal Elegance Hotel. Dengan interior yang megah, kolam renang indoor, dan layanan limusin eksklusif, </p>
                                <div class="d-flex justify-content-between">
                                    <!-- <a class="btn btn-sm btn-primary rounded py-2 px-4" href="">View Detail</a> -->
                                    <a class="btn btn-sm btn-dark rounded py-2 px-4" href="{{ route('book') }}">Book Now</a>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="room-item shadow rounded overflow-hidden">
                            ...
                            <div class="p-4 mt-2">
                                <div class="d-flex justify-content-between mb-3">
                                    <h5 class="mb-0">Ocean Breeze Retreat</h5>
                                    <div class="ps-2">
                                        <small class="fa fa-star text-primary"></small>
                                        <small class="fa fa-star text-primary"></small>
                                        <small class="fa fa-star text-primary"></small>
                                ...
                                <p class="text-body mb-3">Cluster Puri Asri, Blok F5, No. 67</p>
                                <p class="text-body mb-3">Terletak di tepi pantai, Ocean Breeze Retreat menawarkan akomodasi yang menyenangkan dengan sentuhan pantai yang segar. </p>
                                <div class="d-flex justify-content-between">
                                    <!-- <a class="btn btn-sm btn-primary rounded py-2 px-4" href="">View Detail</a> -->
                                    <a class="btn btn-sm btn-dark rounded py-2 px-4" href="{{ route('book') }}">Book Now</a>
                                </div>
