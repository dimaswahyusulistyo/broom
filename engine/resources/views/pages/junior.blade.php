        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h6 class="section-title text-center text-primary text-uppercase">Junior Rooms</h6>
                    <h1 class="mb-5">Jenis  <span class="text-primary text-uppercase">JUNIOR <h1 class="mb-5">Rooms</span></h1>
                </div>
                <div class="row g-4">
                        ...
                        <div class="room-item shadow rounded overflow-hidden">
                            ...
                            <div class="p-4 mt-2">
                                <div class="d-flex justify-content-between mb-3">
                                    <h5 class="mb-0">Grand Vista Hotel</h5>
                                    <div class="ps-2">
                                ...
                                <p class="text-body mb-3">Jl. Melati Indah No. 123, Kota Bahagia </p>
                                <p class="text-body mb-3">Nikmati ketenangan Grand Vista Hotel, Fasilitas termasuk spa mewah, kolam renang infinity, dan restoran gourmet dengan menu beragam. </p>
                                <div class="d-flex justify-content-between">
                                    <!-- <a class="btn btn-sm btn-primary rounded py-2 px-4" href="">View Detail</a> -->
                                    <a class="btn btn-sm btn-dark rounded py-2 px-4" href="{{ route('book') }}">Book Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="room-item shadow rounded overflow-hidden">
                            ...
                            <div class="p-4 mt-2">
                                <div class="d-flex justify-content-between mb-3">
                                    <h5 class="mb-0">Urban Oasis Suites</h5>
                                    <div class="ps-2">
                                        <small class="fa fa-star text-primary"></small>
                                        <small class="fa fa-star text-primary"></small>
                                        <small class="fa fa-star text-primary"></small>
                                ...
                                <p class="text-body mb-3">Blok C2, Perumahan Mawar Sari, Desa Sentosa</p>
                                <p class="text-body mb-3">Kamar-kamar berdesain modern, spa eksklusif, dan lounge atap dengan pemandangan kota membuatnya menjadi tempat yang ideal untuk bisnis dan liburan.</p>
                                <div class="d-flex justify-content-between">
                                    <!-- <a class="btn btn-sm btn-primary rounded py-2 px-4" href="">View Detail</a> -->
                                    <a class="btn btn-sm btn-dark rounded py-2 px-4" href="{{ route('book') }}">Book Now</a>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="room-item shadow rounded overflow-hidden">
                            ...
                            <div class="p-4 mt-2">
                                <div class="d-flex justify-content-between mb-3">
                                    <h5 class="mb-0">Mystic Moonlight Inn</h5>
                                    <div class="ps-2">
                                        <small class="fa fa-star text-primary"></small>
                                        <small class="fa fa-star text-primary"></small>
                                        <small class="fa fa-star text-primary"></small>
                                ...
                                <p class="text-body mb-3">Apartemen Ceria Tower 567, Jl. Damai Abadi</p>
                                <p class="text-body mb-3">Kamar-kamar dengan jendela-jendela besar memberikan pandangan eksklusif ke hutan, sementara restoran bergaya menyajikan hidangan lezat.</p>
                                <div class="d-flex justify-content-between">
                                    <!-- <a class="btn btn-sm btn-primary rounded py-2 px-4" href="">View Detail</a> -->
                                    <a class="btn btn-sm btn-dark rounded py-2 px-4" href="{{ route('book') }}">Book Now</a>
                                </div>
